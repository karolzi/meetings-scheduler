...
class SchedulerTest extends SpecificationWithJUnit {
  ...
  "test" should {
    "find one common slot for 4 users" in new CalendarScope {
      ...
      val result = new Scheduler().findSlots(attendees, timePeriodToBeScanned, meetingLengthMinutes, nrOfSlotsToBeFound)
    ...
    "find two common slots for 4 sfesrfwerwe" in new CalendarScope {
      ...
      val attendee1 = new AttendeeScheduleInfo("Attendee 1", ZoneWarsaw, LocalTimeSlot(new LocalTime("09:00"), new LocalTime("17:00")),
        List()
      )
  ...
  protected trait CalendarScope extends Scope {
    ...
    protected val maria = new AttendeeScheduleInfo("Maria", ZoneWarsaw, workingHours_8_17,
      List(
    ...
    protected val john= new AttendeeScheduleInfo("John", ZoneNewYork, workingHours_9_17,
      List(
    ...
    protected val tom = new AttendeeScheduleInfo("Tom", ZoneWarsaw, workingHours_9_17,
      List(
        new Interval(parseWarsawDateToUTC("2015-04-04 10:00"), parseWarsawDateToUTC("2015-04-04 11:00"))
      )
    )

    protected val jack = new AttendeeScheduleInfo("Jack", ZoneWarsaw, workingHours_12_20, List())
